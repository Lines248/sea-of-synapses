    ...
    >
      ...
      <div className="mb-9 flex items-start justify-between gap-5">
        <div className="flex-1">
          ...
          <h2 className="text-[32px] font-extrabold tracking-[-0.02em] mb-3 bg-gradient-to-r from-sky-50 via-cyan-50 to-sky-50 bg-clip-text text-transparent leading-[1.1]">
            {node.label}
          </h2>
